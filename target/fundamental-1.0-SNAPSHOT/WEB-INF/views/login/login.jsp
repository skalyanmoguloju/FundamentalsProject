...
<head>
    ...
    <style type="text/css">
        ...
        body.authorization div.panel {
            ...
            margin: 0;
            background: #fff url("https://launchpad-asset3.37signals.com/images/bkd_modal_stripes.gif?1455655026") repeat-x scroll top right;
        }
        ...
        body.authorization h1 {
            ...
            height: 25px;
            padding-top: 6px;
            background: url("https://launchpad-asset0.37signals.com/images/basecamp_auth_logo.png?1455655026") no-repeat scroll center right;
        }
        ...
        @media only screen and (max-device-width: 480px) {
            ...
            body.authorization h1 { background-image: url("https://launchpad-asset0.37signals.com/images/basecamp_auto_logo_sml.png?1455655026"); padding-right: 30px; height: 40px; }
            body.authorization div.panel { padding: 7px 15px 28px 15px; background: #fff url("https://launchpad-asset3.37signals.com/images/bkd_modal_stripes_tall.gif?1455655026") repeat-x scroll top right; }
        ...
        (min-resolution: 1.3dppx) {
            body.authorization h1 { background-image: url("https://launchpad-asset3.37signals.com/images/basecamp_auth_logo@2x.png?1455655026"); background-size: 109px 25px; }

            body.authorization div.panel { background-image: url("https://launchpad-asset2.37signals.com/images/bkd_modal_stripes@2x.gif?1455655026"); background-size: 39px 43px; }

            @media only screen and (max-device-width: 480px) {
                body.authorization div.panel { background-image: url("https://launchpad-asset3.37signals.com/images/bkd_modal_stripes_tall.gif?1455655026"); background-size: 80px 60px; }
            }
        }
        ...
        html > body.basecamp_only div#header h2 a {
            ...
            height: 0;
            text-indent: -999em;
            background: url("https://launchpad-asset1.37signals.com/images/bc_logo.png?1455655026") no-repeat left top;
        }
        ...
        (min-device-pixel-ratio: 1.3),
        (min-resolution: 1.3dppx) {
            html > body.basecamp_only div#header h2 a { background-image: url("https://launchpad-asset1.37signals.com/images/bc_logo@2x.png?1455655026"); background-size: 138px 82px;}
        }
        ...
        div.button a,
        div.button a:hover {
            background: url("https://launchpad-asset0.37signals.com/images/buttons/button_left.gif") 0 0 no-repeat !important;
        ...
        div.button a span {
            background: url("https://launchpad-asset0.37signals.com/images/buttons/button_right.gif") 100% 0 no-repeat;
            color: #000000;
            display: block;
        ...
        body.identity_validation div.validated_field.invalid p.field {
            background: url("https://launchpad-asset2.37signals.com/images/icon_fail.png?1455655026") no-repeat right center;
        }
        ...
        *:first-child+html body.identifications div.pick {
        ...
        div.thanks_for_assembling {
            background: url("https://launchpad-asset0.37signals.com/images/thank_you_flash_arrow.png?1455655026") 68px bottom no-repeat; width: 730px; padding-bottom: 20px; margin-bottom: 12px; margin-top: -30px;
        }
        ...
        body.edit_settings div#header h2 a {
            ...
            margin-top: -5px;
            padding-top: 4px;
            background: url("https://launchpad-asset1.37signals.com/images/identity_sprites.png?1455655026") no-repeat -390px 0px;
            padding-left: 142px;
        }
        ...
        body.login div.loading {background: url("https://launchpad-asset0.37signals.com/images/login_sprites.png?1455655026") no-repeat 0px -850px;}
        body.users div.loading {background: url("https://launchpad-asset1.37signals.com/images/identity_sprites.png?1455655026") no-repeat 0px -850px;}
        ...
        *:first-child+html body.users.launching div.container {
        ...
        body.users div.product div.account span.logo {
            ...
            width: 98px;
            height: 0;
            background: url("https://launchpad-asset1.37signals.com/images/identity_sprites.png?1455655026") no-repeat left top;
            display: block;
            padding: 70px 0 0;
            overflow: hidden;
            text-decoration: none;
        ...
        body.users div.product div.menu_container div.menu_target div.arrow {
            height: 18px;
            width: 18px;
            background: transparent url("https://launchpad-asset1.37signals.com/images/identity_sprites.png?1455655026") no-repeat -414px -52px;
        }
        ...
        body.users div.product div.menu_container div.menu_target:hover div.arrow {
            background: transparent url("https://launchpad-asset1.37signals.com/images/identity_sprites.png?1455655026") no-repeat -390px -52px;
        }
        ...
        (min-resolution: 1.3dppx) {
            ...
            body.verifications_setup div.loading {background-image: url("https://launchpad-asset0.37signals.com/images/login_sprites@2x.png?1455655026"); background-size: 1432px 1547px; }
            ...
            body.users > div.rocket div.account span.logo,
            body.users div.product div.menu_container div.menu_target div.arrow,
            body.users div.product div.menu_container div.menu_target:hover div.arrow { background-image: url("https://launchpad-asset2.37signals.com/images/identity_sprites@2x.png?1455655026"); background-size: 1432px 200px; }
        }
        ...
        *:first-child+html div#launchbar li.menu ul.items {
            padding: 0 3px 3px 0;
            background: none;
            background: url("https://launchpad-asset1.37signals.com/images/signal_id/launchbar_bg.png?1453132771") repeat;
        }
        ...
        *:first-child+html body.simple_form span.overlay_wrapper label.overlabel {
        ...
        #rsvp_avatar_upload div.frame div.photo {
            ...
            border: 1px solid #d9d9d9;
            display: block;
            background: #e9eef0 url("https://launchpad-asset3.37signals.com/images/rsvp_avatar_blank.png?1455655026") no-repeat scroll center center;
            text-align: center;
        }
        ...
        #rsvp_avatar_upload div.file_input_button button {
            ...
            text-indent: -9000px;
            border: none;
            background: url("https://launchpad-asset1.37signals.com/images/rsvp_button_upload_photo.png?1455655026") no-repeat scroll top left;
        }
        ...
        #rsvp_avatar_upload div.progress {
            ...
            height: 5px;
            width: 182px;
            background: url("https://launchpad-asset0.37signals.com/images/dots-white.gif?1455655026") no-repeat scroll center center;
        }
        ...
        body.login div#header h1 a {
            display: block;
            height: 28px;
            background: url("https://launchpad-asset0.37signals.com/images/login_sprites.png?1455655026") no-repeat -500px -784px;
        }
        ...
        body.login.basecamp div#login_content {
            background: url("https://launchpad-asset2.37signals.com/images/login_BC.png?1455655026") no-repeat 180px 42px;
        }

        body.login.highrise div#login_content {
            background: url("https://launchpad-asset2.37signals.com/images/login_HR.png?1455655026") no-repeat 180px 42px;
        }
        ...
        body.login.campfire div#login_content {
            background: url("https://launchpad-asset3.37signals.com/images/login_CF.png?1455655026") no-repeat 180px 42px;
        }
        ...
        *:first-child+html body.login div.extras ul li {
        ...
        (min-resolution: 1.3dppx) {
            body.login.bcx div#login_content,
            body.login.basecamp div#login_content { background-image: url("https://launchpad-asset2.37signals.com/images/login_BC@2x.png?1455655026"); background-size: 216px 305px; }
            ...
            body.login.campfire div#login_content { background-image: url("http://www.vijem.ch/wp-content/uploads/2014/10/coquino-affiche1-432x610.jpg"); background-size: 216px 305px; }
            body.login.backpack div#login_content { background-image: url("https://launchpad-asset3.37signals.com/images/login_BP@2x.png?1455655026"); background-size: 216px 305px; }
            body.login.bc3 div#login_content { background-image: url("https://launchpad-asset0.37signals.com/images/login_BC3@2x.png?1455655026");  background-size: 100px 80px; }
            body.login div#header h1 a { background-image: url("https://launchpad-asset0.37signals.com/images/login_sprites@2x.png?1455655026"); background-size: 1432px 1547px; }
        }
        ...
        body.verifications_setup div.loading {background: url("https://launchpad-asset0.37signals.com/images/login_sprites.png?1455655026") no-repeat 0px -850px;}
