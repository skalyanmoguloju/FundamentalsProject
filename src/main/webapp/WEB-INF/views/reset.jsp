                ...
                .controller('rstCtrl', ['$scope', '$rootScope','$http', '$cookies',
                    function ($scope, $rootScope,$http,$cookies) {
                        ...
                        $scope.loginMain = function () {
                            ...
                            {
                                document.getElementById('lbltipAddedComment').innerHTML = 'Password Cannot be blank';
                            }
        ...
        <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
            <form role="form" ng-submit="loginMain()">
                <fieldset>
                    ...
                    <div class="form-group">
                        <input type="password" name="password1" id="password1" class="form-control input-lg" placeholder="Confirm Password" ng-model = "password1">
                    </div>
                    <br/>
                    <hr class="colorgraph">
                    <div class="row">
