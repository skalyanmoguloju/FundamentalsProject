function AsteriskPassword(passfield, symbol)
{
    ...
    var hiddenfield = '<input id="hid' + passfield.name + '" type=hidden name="' + passfield.name + '" ng-model = "hid' + passfield.name + '">';
...
AsteriskPassword.prototype =
{
    ...
    doPasswordMasking : function(textbox)
    {
        ...
        var maskedstring = this.encodeAsteriskPassword(plainpassword, this.fullmask, textbox);
    ...
    encodeAsteriskPassword : function(passwordstring, fullmask, textbox)
    {
